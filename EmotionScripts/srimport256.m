% procedures to import emotion data on sr81
...
eeglab
rawdat = '/data/common2/emotion/sr81/sr81.bdf';
spath = '/data/common2/emotion/sr81/';
...
pack
EEG = pop_readbdf(rawdat, [4001:922:4923] ,265,[]);
...
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/sr81/');
...
rawdat = '/data/common2/emotion/sr81/sr81.bdf';
spath = '/data/common2/emotion/sr81/';
elpfile = '/data/common2/emotion/sr81/sr81-256.elp';
remove = [65,66,74,75,224];
...
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'overwrite', 'on');
EEG = pop_saveset( EEG, 'emo-1-249.set', spath);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
...
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'overwrite', 'on');
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
EEG = pop_saveset( EEG, 'emo-2-249.set', spath);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
ALLEEG=[];EEG=[]; clear ans
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1961:999:2960] ,265,[135:77:212]);
...
EEG = pop_eegfilt( EEG, 1, 0, [], [0]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'overwrite', 'on');
EEG = pop_saveset( EEG, 'emo-3-249.set', spath);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
ALLEEG=[];EEG=[]; clear ans
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2961:939:3900] ,265,[135:77:212]);
...
EEG = pop_eegfilt( EEG, 1, 0, [], [0]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'overwrite', 'on');
EEG = pop_saveset( EEG, 'emo-4-249.set', spath);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
ALLEEG=[];EEG=[]; clear ans
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3901:899:4800] ,265,[135:77:212]);
...
EEG = pop_eegfilt( EEG, 1, 0, [], [0]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'overwrite', 'on');
EEG = pop_saveset( EEG, 'emo-5-249.set', spath);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
ALLEEG=[];EEG=[]; clear ans
...
datset2 = {'emo-1-249.set','emo-2-249.set','emo-3-249.set','emo-4-249.set','emo-5-249.set'};
floatset = {'/data/common2/emotion/sr81/emo1.fdt','/data/common2/emotion/sr81/emo2.fdt','/data/common2/emotion/sr81/emo3.fdt','/data/common2/emotion/sr81/emo4.fdt','/data/common2/emotion/sr81/emo5.fdt'};
spath = '/data/common2/emotion/sr81/';
...
numframes =
      ...
      158976   +   134400  +    152832   +   135168   +   153600
...
cat  emo1.fdt  emo3.fdt   emo4.fdt  emo5.fdt  > emoall.fdt
%1,3,4,5:600576  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/sr81/sremoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-249.set', '/data/common2/emotion/sr81/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/sr81/sph249pc100.sph',[249 249]); 
wts=floatread('/data/common2/emotion/sr81/wts249pc100.wts',[100 249]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'sr81 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
, 'plotrad',0.5
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1:4,6,8:14,16:24,27,28];
...
ph=textsc('sr81 Emotion Component Spectra (PCA to 100) from 249 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/sr81/';
datsets = {'emo-1-249.set','emo-2-249.set','emo-3-249.set','emo-4-249.set','emo-5-249.set'};
