% procedures to import emotion data on mr72 (second session)
...
eeglab
rawdat = '/data/common2/emotion/mr72-2/mr72-2.bdf';
spath = '/data/common2/emotion/mr72-2/';
...
pack
EEG = pop_readbdf(rawdat, [4001:153:4154] ,265,[]);   
...
ALLEEG=[];EEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/mr72-2/');
...
rawdat = '/data/common2/emotion/mr72-2/mr72-2.bdf';
spath = '/data/common2/emotion/mr72-2/';
elpfile = '/data/common2/emotion/mr72-2/mr72-2-256.elp';
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [931:888:1819] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1820:875:2695] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2696:904:3600] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3601:803:4404] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 mr72  - ~32 yo female
data collected on June 24,2004  using 256 (265 including analog) Biosemi acquisition system
...
Performed NO Button Emotion task # 2

% Look at data and find bad channels
remove = [24,25,27,66,68,101,158,164,177,185,213,214,217,218,223,224,235];
datset = {'emo-1-254.set','emo-2-254.set','emo-3-254.set','emo-4-254.set','emo-5-254.set'};
datset2 = {'emo-1-237.set','emo-2-237.set','emo-3-237.set','emo-4-237.set','emo-5-237.set'};
floatset = {'/data/common2/emotion/mr72/emo1.fdt','/data/common2/emotion/mr72/emo2.fdt','/data/common2/emotion/mr72/emo3.fdt','/data/common2/emotion/mr72/emo4.fdt','/data/common2/emotion/mr72/emo5.fdt'};
spath = '/data/common2/emotion/mr72/';
...
numframes =
      ...
      158208  +    150528  +    145920  +    162816   +   108288
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/mr72/mr72emoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-237.set', '/data/common2/emotion/mr72/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/mr72/sph237pc100.sph',[237 237]); 
wts=floatread('/data/common2/emotion/mr72/wts237pc100.wts',[100 237]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [37:72] , 'mr72 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1:3,6:8,10:14,16,19];
...
ph=textsc('mr72 Emotion Component Spectra (PCA to 100) from 237 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/mr72/';
datsets = {'emo-1-237.set','emo-2-237.set','emo-3-237.set','emo-4-237.set','emo-5-237.set'};
