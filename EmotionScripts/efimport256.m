% procedures to import emotion data on ef76
...
eeglab
rawdat = '/data/common2/emotion/ef76/ef76.bdf';
spath = '/data/common2/emotion/ef76/';
...
pack
EEG = pop_readbdf(rawdat, [4001:121:4122] ,265,[]);
...
ALLEEG=[];EEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/ef76/');
...
for k = 1:length(emos)
    ...
    thresh = maxdata*.4;  % sets threshold at 10% of max value
    r=1; 
...
rawdat = '/data/common2/emotion/ef76/ef76.bdf';
spath = '/data/common2/emotion/ef76/';
elpfile = '/data/common2/emotion/ef76/ef76-256.elp';
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [951:509:1460] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1461:839:2300] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2301:921:3232] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3201:915:4116] ,265,[135:77:212]); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 ef76  - ~28 yo male
data collected on Nov 11, 2004  using 256 (265 including analog) Biosemi acquisition system
...
remove = [1,207,211,221,224,237];
remove = [74,94,135,136,137,138,139,140,141];
remove = [101];
remove = [70,178];
    datset = {'emo-1-254.set','emo-2-254.set','emo-3-254.set','emo-4-254.set','emo-5-254.set'};
datset2 = {'emo-1-248.set','emo-2-248.set','emo-3-248.set','emo-4-248.set','emo-5-248.set'};
datset3 = {'emo-1-239.set','emo-2-239.set','emo-3-239.set','emo-4-239.set','emo-5-239.set'};
datset4 = {'emo-1-238.set','emo-2-238.set','emo-3-238.set','emo-4-238.set','emo-5-238.set'};
datset5 = {'emo-1-236.set','emo-2-236.set','emo-3-236.set','emo-4-236.set','emo-5-236.set'};
floatset = {'emo1.fdt','emo2.fdt','emo3.fdt','emo4.fdt','emo5.fdt'};
spath = '/data/common2/emotion/ef76/';
for r = 1:length(datset4)
r=4;
    EEG = pop_loadset( datset4{r},spath); 
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);
EEG = pop_select( EEG, 'nochannel',remove );
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET, 'overwrite', 'on');
EEG = pop_saveset( EEG,datset5{r} , spath);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
ALLEEG=[]; EEG=[];
...
numframes =
      ...
      103424  +     39936  +     99328  +    113152  +    111616
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/ef76/efemoICA.sc



eeglab;  chan = 236;  spath = '/data/common2/emotion/ef76/';  sname = 'ef76';
...
subj = [5,6,8,10,12,13,15,17,18,20,22];
...
spath = '/data/common2/emotion/ef76/';
datsets = {'emo-1-236.set','emo-2-236.set','emo-3-236.set','emo-4-236.set','emo-5-236.set'};
