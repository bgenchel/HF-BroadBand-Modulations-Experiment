% procedures to import emotion data on hs83
...
eeglab
rawdat = '/data/common2/emotion/hs83/hs83.bdf';
spath = '/data/common2/emotion/hs83/';
...
pack
EEG = pop_readbdf(rawdat, [5001:311:5312] ,265,[]);
...
ALLEEG=[];EEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/hs83/');
...
for k = 1:length(emos)
    ...
    thresh = maxdata*.6;  % sets threshold at 10% of max value
    r=1; 
...
rawdat = '/data/common2/emotion/hs83/hs83.bdf';
spath = '/data/common2/emotion/hs83/';
elpfile = '/data/common2/emotion/hs83/hs83-256.elp';
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [681:969:1650] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1651:999:2650] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2651:849:3500] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3501:879:4380] ,265,[135:77:212]); 
...
ALLEEG=[];EEG=[]; clear ans
%%%%%%  block 6  %%%%%%%
EEG = pop_readbdf(rawdat, [4380:915:5295] ,265,[135:77:212]); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 hs83  - ~21 yo female
data collected on Nov 12, 2004  using 256 (265 including analog) Biosemi acquisition system
...
numframes =
      ...
      118272  +    169984   +   188928   +   153088   +   134144
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/hs83/hsemoICA.sc



eeglab;  chan = 249;  spath = '/data/common2/emotion/hs83/';  sname = 'hs83';
...
subj = [1:6,11,12,14,15,16,17,19:22,24:28,30,31,33,34];
...
spath = '/data/common2/emotion/hs83/';
datsets = {'emo-1-249.set','emo-2-249.set','emo-3-249.set','emo-4-249.set','emo-5-249.set','emo-6-249.set'};
...
EEG.event(end+1) = EEG.event(end);
 EEG.event(end).type = 24;         
 EEG.event(end).latency = 255487;
