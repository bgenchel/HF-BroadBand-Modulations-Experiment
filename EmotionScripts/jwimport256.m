% procedures to import emotion data on jw84
...
eeglab
rawdat = '/data/common2/emotion/jw84/jw84.bdf';
spath = '/data/common2/emotion/jw84/';
...
pack
EEG = pop_readbdf(rawdat, [3001:1099:4100] ,265,[]);
...
ALLEEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/jw84/');
...
rawdat = '/data/common2/emotion/jw84/jw84.bdf';
spath = '/data/common2/emotion/jw84/';
elpfile = '/data/common2/emotion/jw84/jw84-256.elp';
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1001:999:2000] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [2001:999:3000] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [3001:1069:4070] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 jw84  - ~20 yo female
data collected on July 22,2004  using 256 (265 including analog) Biosemi acquisition system
...
datset2 = {'emo-1-251.set','emo-2-251.set','emo-3-251.set','emo-4-251.set'};
floatset = {'emo1.fdt','emo2.fdt','emo3.fdt','emo4.fdt'};
spath = '/data/common2/emotion/jw84/';
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/jw84/jwemoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-254.set', '/data/common2/emotion/jw84/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/jw84/sph251pc100.sph',[251 251]); 
wts=floatread('/data/common2/emotion/jw84/wts251pc100.wts',[100 251]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'jw84 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [2,5,7:9,11,12,14,15,16,17,18,20,21,24,25,26,29,32];
...
ph=textsc('jw84 Emotion Component Spectra (PCA to 100) from 250 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/jw84/';
datsets = {'emo-1-251.set','emo-2-251.set','emo-3-251.set','emo-4-251.set'};
