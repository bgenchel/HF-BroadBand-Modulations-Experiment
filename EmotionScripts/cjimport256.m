% procedures to import emotion data on cj82
...
eeglab
rawdat = '/data/common2/emotion/cj82/cj82.bdf';
spath = '/data/common2/emotion/cj82/';
...
pack
EEG = pop_readbdf(rawdat, [1001:999:2000] ,265,[]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 9,  'setname', 'emo 9');
EEG = pop_select( EEG, 'channel',257);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, 9);
pack
EEG = pop_readbdf(rawdat, [2001:999:3000] ,265,[]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 10,  'setname', 'emo 10');
EEG = pop_select( EEG, 'channel',257);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, 10);
pack
EEG = pop_readbdf(rawdat, [3001:633:3634] ,265,[]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 11,  'setname', 'emo 11');
EEG = pop_select( EEG, 'channel',257);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, 11);
pack


eeglab redraw
EEG = pop_mergeset( ALLEEG, [1:11 ], 0);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'setname', 'Button Press, whole session', 'overwrite', 'off');
EEG = pop_mergeset( ALLEEG, [8:11 ], 0);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'setname', 'session 2', 'overwrite', 'off');
...
ALLEEG=[];EEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/cj82/');
...
rawdat = '/data/common2/emotion/cj82/cj82.bdf';
spath = '/data/common2/emotion/cj82/';
elpfile = '/data/common2/emotion/cj82/cj82-256.elp';

%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:719:720] ,265,[135:77:212]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [721:709:1430] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1431:935:2366] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2367:999:3366] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3367:708:4075] ,265,[135:77:212]); % truncated cuz end of file is corruputed.
...
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
ALLEEG=[];EEG=[]; clear ans
pack  % skipping dead space. Assuming excite was 340 s long
%%%%%%  block 6  %%%%%%%
rawdat = '/data/common2/emotion/cj82/cj82-2.bdf';
EEG = pop_readbdf(rawdat, [1:799:800] ,265,[135:77:212]);
...
%%%%%%  block 7  %%%%%%%
rawdat = '/data/common2/emotion/cj82/cj82-2.bdf';
EEG = pop_readbdf(rawdat, [801:919:1720] ,265,[135:77:212]);
...
%%%%%%  block 8  %%%%%%%
rawdat = '/data/common2/emotion/cj82/cj82-2.bdf';
EEG = pop_readbdf(rawdat, [1721:839:2560] ,265,[135:77:212]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,  'setname', 'emo part 7');
EEG = pop_select( EEG, 'nochannel',[255:264] );
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
EEG.chanlocs=pop_chanedit(EEG.chanlocs,  'load',{ elpfile, 'filetype', 'autodetect'}, 'forcelocs',{0, 'X', 'B12'}, 'convert',{ 'chancenter',[],0});
...
%%%%%%  block 9  %%%%%%%
rawdat = '/data/common2/emotion/cj82/cj82-2.bdf';
EEG = pop_readbdf(rawdat, [2561:779:3340] ,265,[135:77:212]);
...
%%%%%%  block 10  %%%%%%%
rawdat = '/data/common2/emotion/cj82/cj82-2.bdf';
EEG = pop_readbdf(rawdat, [3341:289:3630] ,265,[135:77:212]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,  'setname', 'emo part 10');
EEG = pop_select( EEG, 'nochannel',[255:264] );
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
EEG.chanlocs=pop_chanedit(EEG.chanlocs,  'load',{ elpfile, 'filetype', 'autodetect'}, 'forcelocs',{0, 'X', 'B12'}, 'convert',{ 'chancenter',[],0});
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
...
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,  'overwrite', 'on');
 EEG = pop_eegfilt( EEG, 0, 50, [], [0]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET, 'overwrite', 'on');
EEG = pop_saveset( EEG, 'emo-10-254.set', spath);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
ALLEEG=[];EEG=[]; clear ans
pack
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 cj82  - ~24 yo female
data collected on August 12,2004  using 256 (265 including analog) Biosemi acquisition system
...
remove = [8,48,202,204,205,248];
datset = {'emo-1-254.set','emo-2-254.set','emo-3-254.set','emo-4-254.set','emo-5-254.set','emo-6-254.set','emo-7-254.set','emo-8-254.set','emo-9-254.set','emo-10-254.set'};
datset2 = {'emo-1-248.set','emo-2-248.set','emo-3-248.set','emo-4-248.set','emo-5-248.set','emo-6-248.set','emo-7-248.set','emo-8-248.set','emo-9-248.set','emo-10-248.set'};
floatset = {'emo1.fdt','emo2.fdt','emo3.fdt','emo4.fdt','emo5.fdt','emo6.fdt','emo7.fdt','emo8.fdt','emo9.fdt','emo10.fdt'};
spath = '/data/common2/emotion/cj82/';
...
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
    ...
    EEG = pop_rejtrend(EEG,1,[1:size(EEG.data,1)] ,750,75,0.6,2,1);
...
numframes =
 ...
 71424   +  54528 +  89088  +   79104  +   54528  +   75264+ 111360  +  108288  +   95232 +   33024
...
cat  emo1.fdt  emo2.fdt  emo3.fdt   emo4.fdt   emo5.fdt   emo6.fdt   emo7.fdt    emo8.fdt    emo9.fdt    emo10.fdt  > emoall.fdt
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/cj82/cjemoICA.sc


% in matlab, call all three in and cat there.
pl = 1;    for evtm = 384:768:size(EEG.data,2)-384  % go up by 3 sec to create 3 sec epochs
        EEG.event(pl).latency = evtm;
        EEG.event(pl).type = 1000;   pl = pl+1;     
    end;
    EEG = pop_epoch( EEG,{1000} , [-1.5 1.5]);
...
eeglab
EEG = pop_loadset( 'emo-1-248.set', '/data/common2/emotion/cj82/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/cj82/sph248pc100.sph',[248 248]); 
wts=floatread('/data/common2/emotion/cj82/wts248pc100.wts',[100 248]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [37:60] , 'cj82 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1:3,7:9,11:15,17:22,25];
...
ph=textsc('cj82 Emotion Component Spectra (PCA to 100) from 248 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/cj82/';
datsets = {'emo-1-248.set','emo-2-248.set','emo-3-248.set','emo-4-248.set','emo-5-248.set','emo-6-248.set','emo-7-248.set','emo-8-248.set','emo-9-248.set','emo-10-248.set'};
