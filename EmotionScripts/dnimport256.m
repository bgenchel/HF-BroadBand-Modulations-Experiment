% procedures to import emotion data on dn86
% 1600 blocks seems to be the limit on import, at least with 2GB
%  event channel  =265
% ****  ref'ed to 135,213.  (E11,G21) (G20 unstable)
...
eeglab
rawdat = '/data/common2/emotion/dn86/dn86.bdf';
spath = '/data/common2/emotion/dn86/';
...
pack
EEG = pop_readbdf(rawdat, [3001:380:3381] ,265,[]);
...
ALLEEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/dn86/');
...
rawdat = '/data/common2/emotion/dn86/dn86.bdf';
spath = '/data/common2/emotion/dn86/';
elpfile = '/data/common2/emotion/dn86/dn86-256.elp';

%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:998:999] ,265,[135:78:213]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1000:940:1940] ,265,[135:78:213]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1941:989:2930] ,265,[135:78:213]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2931:449:3380] ,265,[135:78:213]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 dn86  - ~18 yo female
data collected on July 9,2004  using 256 (265 including analog) Biosemi acquisition system
referenced to channels 135,213 (E11 and G21)  (G20 unstable)
...
floatset = {'/data/common2/emotion/dn86/emo1.fdt','/data/common2/emotion/dn86/emo2.fdt','/data/common2/emotion/dn86/emo3.fdt','/data/common2/emotion/dn86/emo4.fdt'};
spath = '/data/common2/emotion/dn86/';
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/dn86/dnemoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-250.set', '/data/common2/emotion/dn86/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/dn86/sph250pc100.sph',[250 250]); 
wts=floatread('/data/common2/emotion/dn86/wts250pc100.wts',[100 250]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'dn86 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
%print -Pcoloring -dpsc2 [-painters]

subj = [4:8,10:15,17:24,26:28,30,33,35];
...
ph=textsc('dn86 Emotion Component Spectra (PCA to 100) from 250 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
