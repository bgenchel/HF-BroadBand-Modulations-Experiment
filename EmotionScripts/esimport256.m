% procedures to import emotion data on es76
...
eeglab
rawdat = '/data/common2/emotion/es76/es76.bdf';
spath = '/data/common2/emotion/es76/';
...
pack
EEG = pop_readbdf(rawdat, [5001:559:5560] ,265,[]);
...
rawdat = '/data/common2/emotion/es76/es76.bdf';
spath = '/data/common2/emotion/es76/';
elpfile = '/data/common2/emotion/es76/es76-256.elp';
ALLEEG=[];EEG=[];
%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:1009:1010] ,265,[135:78:213]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1011:1009:2020] ,265,[135:78:213]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [2020:830:2850] ,265,[135:78:213]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2851:874:3725] ,265,[135:78:213]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3726:884:4610] ,265,[135:78:213]); % truncated cuz end of file is corruputed.
...
pack  
%%%%%%  block 6  %%%%%%%
EEG = pop_readbdf(rawdat, [4611:939:5550] ,265,[135:78:213]); % truncated cuz end of file is corruputed.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 es76  - ~28 yo female
data collected on August 26,2004  using 256 (265 including analog) Biosemi acquisition system
referenced to channels 135,213 (E11 and G21) 
...
remove = [17,18,29,65,81,93,212,220];
datset = {'emo-1-254.set','emo-2-254.set','emo-3-254.set','emo-4-254.set','emo-5-254.set','emo-6-254.set'};
datset2 = {'emo-1-246.set','emo-2-246.set','emo-3-246.set','emo-4-246.set','emo-5-246.set','emo-6-246.set'};
...
numframes =
      ...
      107520   +   121344   +   108288   +   112896  +    120576   +   126720
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/es76/esemoICA.sc
...
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'es76 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1,4,6,7,8,11,12,14:20];
...
ph=textsc(['es76 Emotion Component Spectra (PCA to 100) from ',int2str(chans),' chan data, set 1'],'title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/es76/';
datsets = {'emo-1-246.set','emo-2-246.set','emo-3-246.set','emo-4-246.set','emo-5-246.set','emo-6-246.set'};
