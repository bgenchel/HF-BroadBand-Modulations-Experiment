...
eeglab
rawdat = '/data/common2/emotion/js75/js75.bdf';
spath = '/data/common2/emotion/js75/';
...
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 5,  'setname', 'emo 4000-5000');
EEG = pop_select( EEG, 'channel',257);
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, 5);
pack
EEG = pop_readbdf(rawdat, [5001:433:5434] ,265,[]);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 6,  'setname', 'emo 5000-');
EEG = pop_select( EEG, 'channel',257);
...
emobuts = {'bawe', 'bfrustration','bjoy','banger','bhappy','bsad','blove' ,'bfear','bcompassion','bjealousy','bcontent','bgrief','brelief','bdisgust','bexcite'};
ALLEEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/js75/');
...
EEG = pop_readbdf(rawdat, [1:959:960] ,265,[135:77:212]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [961:999:1960] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1961:904:2865] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2866:914:3780] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3781:869:4650] ,265,[135:77:212]);
...
ALLEEG=[];EEG=[]; clear ans
%%%%%%  block 6  %%%%%%%
EEG = pop_readbdf(rawdat, [4651:783:5434] ,265,[135:77:212]);
...
js75  - ~29 yo female
data collected on May 27, 2004  using 256 (265 including analog) Biosemi acquisition system
referenced to channels 135,212 (E11 and G20) 
file includes subject debrief and photos of electrodes. Data collected by julie,
subject performed button-press version of task
...
datset2 = {'emo-1-253.set','emo-2-253.set','emo-3-253.set','emo-4-253.set','emo-5-253.set','emo-6-253.set'};
floatset = {'/data/common2/emotion/js75/emo1.fdt','/data/common2/emotion/js75/emo2.fdt','/data/common2/emotion/js75/emo3.fdt','/data/common2/emotion/js75/emo4.fdt','/data/common2/emotion/js75/emo5.fdt','/data/common2/emotion/js75/emo6.fdt'};
spath = '/data/common2/emotion/js75/';
...
%[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
    ...
    [ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
    EEG = pop_rejkurt(EEG,1,[1:size(EEG.data,1)] ,4,3,0,1);        
    EEG = pop_jointprob(EEG,1,[1:size(EEG.data,1)], 4,3,0,1);
...
numframes =
      ...
      121344  +    118272  +    104448  +    152064  +    129024  +    122112
sum = 747264
numframes =

      125184  +    119808  +    107520  +    151296  +    129024  +    122112
sum = 754944


% now in linux

cat  emo1.fdt  emo2.fdt   emo4.fdt  emo5.fdt  emo6.fdt  > emoall.fdt
%1,2,4,5,6: 647424  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/js75/jsemoICA254.sc
...
eeglab
EEG = pop_loadset( 'emo-1-253.set', '/data/common2/emotion/js75/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/js75/sph253pc100.sph',[253 253]); 
wts=floatread('/data/common2/emotion/js75/wts253pc100.wts',[100 253]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'js75 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
, 'plotrad',0.5
subj = [1:10,12:14,16:17,19,22,25];
...
ph=textsc('js75 Emotion Component Spectra (PCA to 100) from 253 chan data, set 1','title');
set(ph,'fontsize',14);


% epoch on emotion
spath = '/data/common2/emotion/js75/';
datsets = {'emo-1-253.set','emo-2-253.set','emo-3-253.set','emo-4-253.set','emo-5-253.set','emo-6-253.set'};
