% procedures to import emotion data on ar81
...
eeglab
rawdat = '/data/common2/emotion/ar81/ar81.bdf';
spath = '/data/common2/emotion/ar81/';
...
pack
EEG = pop_readbdf(rawdat, [3001:1109:4110] ,265,[]);
...
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/ar81/');
...
eeglab
rawdat = '/data/common4/emotion/ar81/ar81.bdf';
spath = '/data/common4/emotion/ar81/';
elpfile = '/data/common4/emotion/ar81/ar81-256.elp';

%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:909:910] ,265,[135:77:212]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [911:1063:1974] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1975:1087:3062] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [3063:1047:4110] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 ar81  - ~23 yo female
data collected on July 2,2004  using 256 (265 including analog) Biosemi acquisition system
...
Performed  Button Emotion task # 3
elp file looks fine.

% Look at data and find bad channels
remove = [13,19,21,30,67,97,100,107,110,116,117,131,136,158,172,188,203,205,206,210,213,216,218];
datset = {'emo-1-254.set','emo-2-254.set','emo-3-254.set','emo-4-254.set'};
datset2 = {'emo-1-231.set','emo-2-231.set','emo-3-231.set','emo-4-231.set'};
floatset = {'/data/common4/emotion/ar81/emo1.fdt','/data/common4/emotion/ar81/emo2.fdt','/data/common4/emotion/ar81/emo3.fdt','/data/common4/emotion/ar81/emo4.fdt'};
spath = '/data/common4/emotion/ar81/';
...
EEG.chanlocs=pop_chanedit(EEG.chanlocs,  'load',{elpfile , 'filetype', 'autodetect'});
if EEG.chanlocs(1).labels == 'Nz'
    EEG.chanlocs(1:3) = [];
end;        
EEG.chanlocs=pop_chanedit(EEG.chanlocs,'forcelocs',{0, 'X', 'B12'}, 'convert',{ 'chancenter',[],0});
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
...
numframes =
       ...
       59904  +     92928   +    86784   +   137472
sum =  377088


numframes =

      119808   +   171264   +   153600   +   194304
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/ar81/aremoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-231.set', '/data/common2/emotion/ar81/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/ar81/sph231pc100.sph',[231 231]); 
wts=floatread('/data/common2/emotion/ar81/wts231pc100.wts',[100 231]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'ar81 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1,2,6,7,8,9,10,11,12,13,22,27];
...
ph=textsc('ar81 Emotion Component Spectra (PCA to 100) from 250 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/ar81/';
datsets = {'emo-1-231.set','emo-2-231.set','emo-3-231.set','emo-4-231.set'};
