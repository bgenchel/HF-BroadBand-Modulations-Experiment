...
%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:954:955] ,265,[135:77:212]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [956:904:1860] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1861:909:2770] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2771:998:3769] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3770:383:4153] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 mr72 (second session)  - ~32 yo female
data collected on August 11,2004  using 256 (265 including analog) Biosemi acquisition system
...
remove = [20,45,69,91,111,123,124,235];
...
numframes =
      ...
      136704   +   137472  +    132096  +    165120  +     59136
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/mr72-2/mremoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-246.set', '/data/common2/emotion/mr72-2/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/mr72-2/sph246pc100.sph',[246 246]); 
wts=floatread('/data/common2/emotion/mr72-2/wts246pc100.wts',[100 246]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'mr72-2 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1:3,6,7,9,10,11,13:15,17:25,28,29];
