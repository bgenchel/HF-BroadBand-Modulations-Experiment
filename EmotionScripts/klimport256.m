% procedures to import emotion data on kl80
...
eeglab
rawdat = '/data/common2/emotion/kl80/kl80.bdf';
spath = '/data/common2/emotion/kl80/';
...
pack
EEG = pop_readbdf(rawdat, [2001:1157:3158] ,265,[]);
...
ALLEEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/kl80/');
...
rawdat = '/data/common2/emotion/kl80/kl80.bdf';
spath = '/data/common2/emotion/kl80/';
elpfile = '/data/common2/emotion/kl80/kl80-256.elp';
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [951:949:1900] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1901:929:2830] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2831:326:3157] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 kl80  - ~24 yo female
data collected on July 7,2004  using 256 (265 including analog) Biosemi acquisition system
...
Performed Button Emotion task # 1

% Look at data and find bad channels
remove = [69,86,118,205,218,219];
datset = {'emo-1-254.set','emo-2-254.set','emo-3-254.set','emo-4-254.set'};
datset2 = {'emo-1-248.set','emo-2-248.set','emo-3-248.set','emo-4-248.set'};
floatset = {'/data/common2/emotion/kl80/emo1.fdt','/data/common2/emotion/kl80/emo2.fdt','/data/common2/emotion/kl80/emo3.fdt','/data/common2/emotion/kl80/emo4.fdt'};
spath = '/data/common2/emotion/kl80/';
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/kl80/klemoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-248.set', '/data/common2/emotion/kl80/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/kl80/sph248pc100.sph',[248 248]); 
wts=floatread('/data/common2/emotion/kl80/wts248pc100.wts',[100 248]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'kl80 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1,2,5:10,15,21,22,23,25,27];
...
ph=textsc('kl80 Emotion Component Spectra (PCA to 100) from 250 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/kl80/';
datsets = {'emo-1-248.set','emo-2-248.set','emo-3-248.set','emo-4-248.set'};
