% procedures to import emotion data on mr71
...
eeglab
rawdat = '/data/common2/emotion/mr71/mr71.bdf';
spath = '/data/common2/emotion/mr71/';
...
pack
EEG = pop_readbdf(rawdat, [4001:451:4452] ,265,[]);   
...
ALLEEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/mr71/');
...
rawdat = '/data/common2/emotion/mr71/mr71.bdf';
spath = '/data/common2/emotion/mr71/';
elpfile = '/data/common2/emotion/mr71/mr71-256.elp';

%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:997:998] ,265,[135:77:212]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [999:981:1980] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1981:919:2900] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2901:899:3800] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3801:650:4451] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 mr71  - ~33 yo male
data collected on June 30,2004  using 256 (265 including analog) Biosemi acquisition system
...
datset2 = {'emo-1-251.set','emo-2-251.set','emo-3-251.set','emo-4-251.set','emo-5-251.set'};
floatset = {'/data/common2/emotion/mr71/emo1.fdt','/data/common2/emotion/mr71/emo2.fdt','/data/common2/emotion/mr71/emo3.fdt','/data/common2/emotion/mr71/emo4.fdt','/data/common2/emotion/mr71/emo5.fdt'};
spath = '/data/common2/emotion/mr71/';
...
numframes =
      ...
      161280  +    137472  +    119040   +   135168   +   101376
...
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/mr71/mr71emoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-251.set', '/data/common2/emotion/mr71/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/mr71/sph251pc100.sph',[251 251]); 
wts=floatread('/data/common2/emotion/mr71/wts251pc100.wts',[100 251]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [37:72] , 'mr71 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1,3,6,7,10:16,18,19,21,25,26,28];
...
ph=textsc('mr71 Emotion Component Spectra (PCA to 100) from 251 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/mr71/';
datsets = {'emo-1-251.set','emo-2-251.set','emo-3-251.set','emo-4-251.set','emo-5-251.set'};
