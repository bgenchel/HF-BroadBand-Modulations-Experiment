% procedures to import emotion data on an82
...
eeglab
rawdat = '/data/common2/emotion/an82/an82.bdf';
spath = '/data/common2/emotion/an82/';
...
pack
EEG = pop_readbdf(rawdat, [5001:866:5867] ,265,[]);
...
ALLEEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/an82/');
...
rawdat = '/data/common2/emotion/an82/an82.bdf';
spath = '/data/common2/emotion/an82/';
elpfile = '/data/common2/emotion/an82/an82-256.elp';

%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:719:720] ,265,[135:77:212]);  % too much
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [721:1049:1770] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1771:879:2650] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2650:910:3560] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3561:1049:4610] ,265,[135:77:212]);
...
pack
%%%%%%  block 6  %%%%%%%
EEG = pop_readbdf(rawdat, [4611:1069:5680] ,265,[135:77:212]);
...
pack
%%%%%%  block 7  %%%%%%%
EEG = pop_readbdf(rawdat, [5681:185:5866] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 an82  - ~22 yo male
data collected on July 21,2004  using 256 (265 including analog) Biosemi acquisition system
...
datset2 = {'emo-1-251.set','emo-2-251.set','emo-3-251.set','emo-4-251.set','emo-5-251.set','emo-6-251.set','emo-7-251.set'};
floatset = {'emo1.fdt','emo2.fdt','emo3.fdt','emo4.fdt','emo5.fdt','emo6.fdt','emo7.fdt'};
spath = '/data/common2/emotion/an82/';
...
numframes =
  ...
  112128   +   165376  +    143872  +    139264   +   169984   +   167936+30720
...
cat  emo1.fdt  emo2.fdt  emo3.fdt   emo5.fdt   emo6.fdt  > emoall.fdt
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/an82/anemoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-251.set', '/data/common2/emotion/an82/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/an82/sph251pc100.sph',[251 251]); 
wts=floatread('/data/common2/emotion/an82/wts251pc100.wts',[100 251]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:36] , 'an82 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [1,2,4:18,21:24,29,32,34];
...
ph=textsc('an82 Emotion Component Spectra (PCA to 100) from 251 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/an82/';
datsets = {'emo-1-251.set','emo-2-251.set','emo-3-251.set','emo-4-251.set','emo-5-251.set','emo-6-251.set','emo-7-251.set'};
