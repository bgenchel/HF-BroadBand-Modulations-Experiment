...
function [outsources, XX, YY, ZZ, XO, YO, ZO] = mydipplot( sourcesori, varargin )
...
function plotimgs(dat, mricoord, transmat);
    ...
    % ploting surfaces ***********************************************************
    % This is the crucial part for plotting FA using dipplot!!
    % ----------------
    %options = { 'FaceColor','texturemap', 'EdgeColor','none', 'CDataMapping',  'direct','tag','img', 'facelighting', 'none' };
    options = { 'FaceColor','texturemap',  'CDataMapping', 'scaled','EdgeColor','none','tag','img'};
    hold on;
