% procedures to import emotion data on dg75
...
eeglab
rawdat = '/data/common2/emotion/dg75/dg75.bdf';
spath = '/data/common2/emotion/dg75/';
...
pack
EEG = pop_readbdf(rawdat, [6001:451:6452] ,265,[]);
...
ALLEEG=[];EEG=[];
EEG = pop_loadset( 'ButtonOnly.set', '/data/common2/emotion/dg75/');
...
for k = 1:length(emos)
    ...
    thresh = maxdata*.15;  % sets threshold at 10% of max value
    r=1; 
...
rawdat = '/data/common2/emotion/dg75/dg75.bdf';
spath = '/data/common2/emotion/dg75/';
elpfile = '/data/common2/emotion/dg75/dg75-256.elp';

%%%%  block 1   %%%%%%%%%
EEG = pop_readbdf(rawdat, [1:699:700] ,265,[135:77:212]);
...
pack
%%%%  block 2   %%%%%%%%%
EEG = pop_readbdf(rawdat, [701:879:1580] ,265,[135:77:212]);
...
pack
%%%%%%  block 3  %%%%%%%
EEG = pop_readbdf(rawdat, [1581:759:2340] ,265,[135:77:212]);
...
pack
%%%%%%  block 4  %%%%%%%
EEG = pop_readbdf(rawdat, [2341:1109:3450] ,265,[135:77:212]);
...
pack
%%%%%%  block 5  %%%%%%%
EEG = pop_readbdf(rawdat, [3451:969:4420] ,265,[135:77:212]);
...
pack
%%%%%%  block 6  %%%%%%%
EEG = pop_readbdf(rawdat, [4421:1089:5510] ,265,[135:77:212]);
...
pack
%%%%%%  block 7  %%%%%%%
EEG = pop_readbdf(rawdat, [5511:940:6451] ,265,[135:77:212]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 dg75  - ~29 yo male
data collected on July 16,2004  using 256 (265 including analog) Biosemi acquisition system
...
remove = [1,9,24,75,121,122,133,138,140,144,210];
datset = {'emo-1-254.set','emo-2-254.set','emo-3-254.set','emo-4-254.set','emo-5-254.set','emo-6-254.set','emo-7-254.set'};
datset2 = {'emo-1-243.set','emo-2-243.set','emo-3-243.set','emo-4-243.set','emo-5-243.set','emo-6-243.set','emo-7-243.set'};
...
numframes =
       ...
       52992  +     87552  +     92928  +    134400  +    117504  +    153600+ 95232
...
cat  emo1.fdt  emo2.fdt  emo3.fdt   emo4.fdt   emo5.fdt   emo6.fdt   emo7.fdt  > emoall.fdt
%  
/data/common/matlab/ica_linux2.4 < /data/common2/emotion/dg75/dgemoICA.sc
...
eeglab
EEG = pop_loadset( 'emo-1-243.set', '/data/common2/emotion/dg75/');
[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG);

sph=floatread('/data/common2/emotion/dg75/sph243pc100.sph',[243 243]); 
wts=floatread('/data/common2/emotion/dg75/wts243pc100.wts',[100 243]); 
EEG.icaweights=wts;
EEG.icasphere=sph;
EEG.icawinv=[];
[ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
pop_topoplot(EEG,0, [1:10] , 'dg75 Emotion Components; PCA to 100 ',[6 6] ,0, 'electrodes', 'off', 'masksurf', 'on');
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
print -Pcoloring -dpsc2 [-painters]

subj = [2,3,5:8,10:12,16:18,21,23,24,27,28];
...
ph=textsc('dg75 Emotion Component Spectra (PCA to 100) from 243 chan data, set 1','title');
set(ph,'fontsize',14);
set(gcf,'PaperOrientation','landscape');
set(gcf,'PaperPosition',[0.25 0.25 10.5 8]);
...
spath = '/data/common2/emotion/dg75/';
datsets = {'emo-1-243.set','emo-2-243.set','emo-3-243.set','emo-4-243.set','emo-5-243.set','emo-6-243.set','emo-7-243.set'};
